...
ancestry.forEach(function(elem) {
...
/*
ancestry.forEach(function(elem) {
	if(byName[elem.mother])
	console.log(byName[elem.mother].born)
})*/


ancestry.forEach(function(elem) {
	if(byName[elem.mother]) {
	diffAges.push(parseInt(elem.born) - parseInt(byName[elem.mother].born))
	}
})

console.log(diffAges)

var diffAgesAver = diffAges.reduce((acum, curr) => {
	return acum + curr
}) / diffAges.length

console.log(diffAgesAver)

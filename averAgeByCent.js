...
ancestry.forEach((elem) => {
	elem.century = Math.trunc(elem.died/100)+1	
})
...
ancestry.forEach((elem)=>{
	if(!masterObj[elem.century]){
		masterObj[elem.century]={"c":	
		elem.century,"a":[],"m":0}
	}
		//console.log(elem.a)
		//console.log(masterObj)
		//console.log(masterObj[elem.c])
		masterObj[elem.century].a.push(elem.died-elem.born)
})
